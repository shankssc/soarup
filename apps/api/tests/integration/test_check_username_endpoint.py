...
class TestCheckUsernameEndpoint:
    async def test_available_username_returns_available_true(
        self, check_username_client
    ):
    ...
    async def test_taken_username_returns_available_false(
        self, check_username_client, db_session
    ):
    ...
    async def test_own_username_returns_available_true(
        self, check_username_client, db_session
    ):
    ...
    async def test_invalid_format_returns_available_false_with_message(
        self, check_username_client
    ):
    ...
    async def test_too_short_username_returns_available_false(
        self, check_username_client
    ):
        response = await check_username_client.get(
            "/api/v1/auth/check-username",
    ...
    async def test_consecutive_hyphens_returns_available_false(
        self, check_username_client
    ):
        response = await check_username_client.get(
            "/api/v1/auth/check-username",
    ...
    async def test_missing_username_param_returns_422(
        self, check_username_client
    ):
    ...
    async def test_case_insensitive_taken_check(
        self, check_username_client, db_session
    ):
